...
main() {
    ...
    source "./$SUP_NVIDIA_DRIVER_INSTALLER_LIB_HOME_PATH$SUP_NVIDIA_DRIVER_INSTALLER_HOME_PATH".index.sh
    source "./$SUP_NVIDIA_DRIVER_INSTALLER_LIB_HOME_PATH$SUP_NVIDIA_DRIVER_INSTALLER_HOME_PATH$SUP_LINUX_CONFIGURER_HOME_PATH".index.sh
    source "./$SUP_NVIDIA_DRIVER_INSTALLER_LIB_HOME_PATH$SUP_NVIDIA_DRIVER_INSTALLER_HOME_PATH$SUP_LINUX_CONFIGURER_HOME_PATH$SUP_LIB_HOME_PATH".index.sh
    source "./$SUP_NVIDIA_DRIVER_INSTALLER_LIB_HOME_PATH$SUP_NVIDIA_DRIVER_INSTALLER_HOME_PATH$SUP_LINUX_CONFIGURER_HOME_PATH$SUP_LIB_HOME_PATH$SRC_FOLDER_PATH_INDEX"
    source "./$SUP_NVIDIA_DRIVER_INSTALLER_LIB_HOME_PATH$SUP_NVIDIA_DRIVER_INSTALLER_HOME_PATH$SUP_LINUX_CONFIGURER_HOME_PATH$SUP_LIB_HOME_PATH$SRC_FOLDER_PATH$PICTURE_FOLDER_PATH_INDEX"
    local JUST_FOR_FUN="./$SUP_NVIDIA_DRIVER_INSTALLER_LIB_HOME_PATH$SUP_NVIDIA_DRIVER_INSTALLER_HOME_PATH$SUP_LINUX_CONFIGURER_HOME_PATH$SUP_LIB_HOME_PATH$SRC_FOLDER_PATH$PICTURE_FOLDER_PATH$NVIDIA_FUCK_U_TXT_FILE_PATH"
